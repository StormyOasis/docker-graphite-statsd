This repo contains a custom docker-graphite-statsd image with a modern installation of grafana sloppily wedged in. You probably don't want to use this repo as it's a one off and not maintained.  
